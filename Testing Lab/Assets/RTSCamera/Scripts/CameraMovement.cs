...
public class CameraMovement : MonoBehaviour
{
    ...
    public float maxMovementY = 10;   //If you dont like zooming while rotating, then set lower number(somethink like 10), but after you will be able to zoom anly by moving on X axes. If your delta position of fingers on Y axes will be higher then this number, than user will not zoom
    [Space(20)]
